...
export class VectaraApi implements ICredentialType {
	name = 'N8nDevVectaraApi';

	displayName = 'vectara API';

	icon: Icon = { light: 'file:../nodes/Vectara/vectara.png', dark: 'file:../nodes/Vectara/vectara.dark.png' };
	...
	properties: INodeProperties[] = [
		{
			...
			required: true,
			placeholder: 'https://api.vectara.io',
			description: 'The base URL of your vectara API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
